...
var campaign_functions = {
    init: function() {
        ...
        if ($('#slot-pot-id').val() == "51" || $('#slot-pot-id').val() == "52") {
            ...
            if ($('#slot-campaign-id').val() == "29" && $('#slot-source-id').val() == "68") {
                //cumbria
                $('#slot-attendee').val('178');
            } else if ($('#slot-campaign-id').val() == "29" && $('#slot-source-id').val() == "59" || $('#slot-campaign-id').val() == "29" && $('#slot-source-id').val() == "41") {
                //peterborough
                $('#slot-attendee').val('121');
            } else if ($('#slot-campaign-id').val() == "29" && $('#slot-source-id').val() == "58") {
                //manchester
