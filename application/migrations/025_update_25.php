...
class Migration_update_25 extends CI_Migration
{
    ...
    {
        $this->db->query("DELETE FROM `role_permissions` WHERE `permission_id` IN (121)");
        $this->db->query("DELETE FROM `permissions` WHERE `permission_id` IN (121)");
    }
}