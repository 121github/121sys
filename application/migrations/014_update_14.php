...
#drop trigger records_before_update
	  ...
	  $this->db->query("ALTER TABLE `audit_values`
  ADD CONSTRAINT `audit_values_ibfk_1` FOREIGN KEY (`audit_id`) REFERENCES `audit` (`audit_id`) ON DELETE CASCADE ON UPDATE CASCADE");
