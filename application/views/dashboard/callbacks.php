                    ...
                    <form class="callbacks-filter" data-func="callbacks_panel">
                        <div class="btn-group">
                            <input type="hidden" name="date_from"
                                   value="<?php echo(!empty($date_from) ? $date_from : date('Y-m-d')); ?>">
                            <input type="hidden" name="date_to"
                                   value="<?php echo(!empty($date_to) ? $date_to : date('Y-m-d')); ?>">
                            ...
                            <button type="button" class="daterange btn btn-default btn-xs"><span
                                    ...
                                    class="date-text"> <?php echo(!empty($btntext) ? $btntext : "Today"); ?> </span>
                            </button>
                        </div>
                        <?php if (!isset($_SESSION['current_campaign'])) { ?>
                            <div class="btn-group">
                                <button type="button" class="btn btn-default btn-xs dropdown-toggle"
                                        data-toggle="dropdown"> Campaign <span class="caret"></span></button>
                        ...
                        <?php if (in_array("by agent", $_SESSION['permissions'])) { ?>
                            <div class="btn-group">
                                <button type="button" class="btn btn-default btn-xs dropdown-toggle"
                                        data-toggle="dropdown"> User <span class="caret"></span></button>
                                <ul class="dropdown-menu pull-right" role="menu">
                                    ...
                                    <?php endforeach ?>
                                    <li class="divider"></li>
                                    <li><a class="filter" ref="#" style="color: green;" data-ref="agent">All Users</a>
                                    </li>
                                </ul>
                            </div>
                        <?php } ?>
                        <?php if (in_array("by team", $_SESSION['permissions'])) { ?>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right" role="menu">
                                    ...
                                    <?php endforeach ?>
                                    <li class="divider"></li>
                                    <li><a class="filter" ref="#" style="color: green;" data-ref="team">All Teams</a>
                                    </li>
                                </ul>
                            </div>
                        <?php } ?>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu pull-right" role="menu">
                                ...
                                <?php endforeach ?>
                                <li class="divider"></li>
                                <li><a class="filter" ref="#" style="color: green;" data-ref="source">All Sources</a>
                                </li>
                            </ul>
                        </div>
                    </form>
