<div class="navbar navbar-inverse navbar-fixed-top" style="margin-top:50px">
    ...
    <p class="navbar-text" style="color:#fff; font-weight:700"><?php echo $title ?></p>
            ...
            <li <?php if($submenu['page']=="campaign"){ echo 'class="active"'; } ?>><a href="<?php echo base_url() ?>reports/outcomes/campaign">Campaign</a></li>
            <li <?php if($submenu['page']=="user"){ echo 'class="active"'; } ?>><a href="<?php echo base_url() ?>reports/outcomes/user">User</a></li>
            <li <?php if($submenu['page']=="date"){ echo 'class="active"'; } ?>><a href="<?php echo base_url() ?>reports/outcomes/date">Date</a></li>
            <li <?php if($submenu['page']=="time"){ echo 'class="active"'; } ?>><a href="<?php echo base_url() ?>reports/outcomes/time">Time</a></li>
             <li <?php if($submenu['page']=="reason"){ echo 'class="active"'; } ?>><a href="<?php echo base_url() ?>reports/outcomes/outcome_reason">Other</a></li>
        </ul>
