...
<?php echo form_open(current_url());?>						
				...
				<?php } ?>
					<a href="<?php echo $base_url; ?>admin/shop/discount_groups">Manage Item Discount Groups</a> | 
					<a href="<?php echo $base_url; ?>admin/shop/insert_discount">Insert New Discount</a>
				</p>
				...
				<?php if (! empty($discount_data)) { ?>	
					...
					?>
						<tr>
							<td class="align_ctr">
								...
								<a href="<?php echo $base_url; ?>admin/shop/update_discount/<?php echo $discount_id; ?>">Edit</a>
							</td>
							<td>
					...
					<tfoot>
						<tr>
							<td colspan="7">
								<input type="submit" name="update_discounts" value="Update Discounts" class="link_button btn btn-default large"/>
							</td>
						</tr>
					</tfoot>
				<?php } else { ?>
