<div class="panel-heading">Send Email <span class="glyphicon glyphicon-remove pull-right close-ownership-trigger-btn"></span></div>
<div class="panel-body">
    <div class="ownership-trigger-panel">
        <div class="ownership-trigger-content">
            <form id="ownership-trigger-form">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="btn-group">
                ...
                <div class="pull-right">
                    ...
                    <span class="marl btn btn-default close-ownership-trigger-btn">Cancel</span>
                    <span class="marl btn btn-success save-ownership-trigger-btn">Save</span>
                </div>
            </form>
        </div>
    </div>
