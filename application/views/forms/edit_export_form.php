  ...
  <form name="edit-export-form" method="post" class="export-form edit-export-form">
    <div class="tab-content">
      <div role="tabpanel" class="tab-pane active" id="query-tab">
        ...
        <div class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control input-sm" name="name" placeholder="Enter the name" required/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2">Description</label>
            <div class="col-sm-10">
              <input type="text" class="form-control input-sm" name="description" placeholder="Enter the description"/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2">Header</label>
              <div class="col-sm-10">
                <textarea rows="3" class="form-control" name="header"
                                  placeholder="Enter the header separated by ;" required></textarea>
              </div>
            </div>
        <div style="border-bottom: 1px solid grey; margin-bottom: 20px; font-weight: bold"> QUERY <span class="pull-right"> <a role="button" class="collapsed" data-toggle="collapse" href="#collapsePreview"> Preview </a> </span> </div>
        <div class="col-lg-12">
      ...
      <div role="tabpanel" class="tab-pane" id="graphs-tab">
        <div style="border-bottom: 1px solid grey; margin-bottom: 20px; font-weight: bold"> GRAPHS <span class="pull-right"> <a role="button" class="collapsed" data-toggle="collapse" href="#collapseGraph"> Add new </a> </span> </div>
        <div class="collapse" id="collapseGraph" style="margin-top: 20px">
          <div class="row">
            <div class="col-lg-12">
              <div class="btn-group" data-toggle="buttons">
                <label class="btn btn-default active">
                  <input type="radio" value="bars" checked="checked" aria-label="..." name="graph_type">
          ...
          <div class="row">
            <div class="col-lg-12"> <span class="btn btn-success btn-xs save-export-graph-btn pull-right"> <span class="fa fa-save"></span> Save </span> </div>
          </div>
          ...
          <div class="col-lg-12">
            <div class="btn-group">
              <div class="form-group input-group-sm">
                ...
                <select id="user_select" class="selectpicker user_select" data-size="7" name="user_id[]" multiple>
                </select>
              </div>
            </div>
          </div>
