<form style="display: none; padding: 10px 20px;" class="form-horizontal">
    ...
    <div class="row">
        ...
        <div class="col-xs-3">
            <div class="form-group pull-right">
                <label for="type">Visible on email panel</label>
                <br>
                <div class="btn-group" data-toggle="buttons">
                    <label class="btn btn-info btn-sm">
                        <input type="radio" name="history_visible" value="1" autocomplete="off"
                               id="history-visible-yes">Yes
                    </label>
                    <label class="btn btn-info btn-sm renewal-label">
                        <input type="radio" name="history_visible" value="0" autocomplete="off"
                               id="history-visible-no">No
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="form-actions pull-left">
			<span class="btn btn-default fileinput-button">
		        ...
		        <input id="fileupload" type="file" name="files[]"
                       data-url="<?php echo base_url() . "templates/upload_template_attach"; ?>">
		    </span>
...
<script>
    ...
    $(function () {
        ...
        $('#fileupload').fileupload({
            ...
            $.ajax({
                url: helper.baseUrl + 'templates/get_attachment_file_path',
                type: "POST",
                dataType: "JSON",
                data: {file: file.name}
