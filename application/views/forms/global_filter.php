 <nav id="global-filter" class="mm-menu mm--horizontal mm-offcanvas">
        <div style="padding:30px 20px 3px">
            ...
            <div class="form-group">
             ...
             <option <?php if(isset($_SESSION['current_campaign'])&&$_SESSION['current_campaign']==$row['id']) { echo "selected"; } else if(isset($_SESSION['report-filter']['values']['pot_id']) && @in_array($row['id'],$_SESSION['report-filter']['values']['pot_id'])){ echo "selected"; } ?> value="<?php echo $row['id'] ?>"><?php echo $row['name'] ?></option>
                            <?php } ?>
                        </optgroup>
                    <?php } ?>
                </select>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                <label>Outcome <span class="glyphicon glyphicon-info-sign pointer tt" data-toggle="tooltip" data-placement="right" data-title="The last outcome on the record"  data-html="true"></span></label>
                ...
                <div class="form-group">
                <label>User <span class="glyphicon glyphicon-info-sign pointer tt" data-toggle="tooltip"  data-placement="right" data-title="The user the record is assigned to"  data-html="true"></span></label>
                ...
                <div class="form-group">
                <label>Branch <span class="glyphicon glyphicon-info-sign pointer tt" data-toggle="tooltip" data-placement="right" data-title="The branch the record is assigned to" data-html="true"></span></label>
                ...
                <div class="form-group">
                <label>Region <span class="glyphicon glyphicon-info-sign pointer tt" data-toggle="tooltip" data-placement="right" data-title="The branch the record is assigned to" data-html="true"></span></label>
              ...
              <?php if(in_array("filter status",$_SESSION['permissions'])){ ?>
               ...
               <?php } ?> 
                ...
                <?php if($_SESSION['data_access']['parked']){ ?>
                 <div class="form-group">
                <label>Parked Records <span class="glyphicon glyphicon-info-sign pointer tt" data-toggle="tooltip" data-placement="right" data-title="Records that are not to be worked for various reasons" data-html="true"></span></label>
                   <select name="parked_code[]" title="Any Status" multiple class="selectpicker" data-width="100%"> 
            ...
            <div class="form-group">
                <label>Postcode <span class="glyphicon glyphicon-info-sign pointer tt" data-toggle="tooltip" data-placement="right" data-title="Enter a postcode to find records in the same area" data-html="true"></span></label>
   ...
   <?php if(in_array("filter postcode",$_SESSION['permissions'])){ ?>
                   <div class="form-group">
                <label>Distance <span class="glyphicon glyphicon-info-sign pointer tt" data-toggle="tooltip" data-placement="right" data-title="Enter a distance to search from the postcode entered" data-html="true"></span></label>
