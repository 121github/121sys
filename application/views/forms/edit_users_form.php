<form style="display:none; padding:10px 20px;" class="form-horizontal">
    ...
    <div class="form-group input-group-sm">
        <p>Attendee <span data-toggle='tooltip' title='Can appointments be booked for this user?'
                          class='fa fa-question-circle'></span></p>
    ...
    <div class="form-group input-group-sm">
        <p>User Default Postcode <span data-toggle='tooltip'
                                       title='This could be a the home or office postcode and is used in distance calculations when booking appointments'
                                       class='fa fa-question-circle'></span></p>
        <input type="text" class="form-control" name="home_postcode" title="Enter the default postcode" required/>
    </div>

    <div class="form-group input-group-sm">
        <p>Enable ICS (calendar invites) <span data-toggle='tooltip'
                                               title='If enabled the user will be sent a calendar invite to their associated email address whenever an appointment is booked for them'
                                               class='fa fa-question-circle'></span></p>
    ...
    <div class="form-group input-group-sm">
        <p>Please set the campaigns associated to the user</p>
        <select name="campaigns[]" multiple class="selectpicker" data-live-search="true" data-live-search-placeholder="Search" data-actions-box="true">
