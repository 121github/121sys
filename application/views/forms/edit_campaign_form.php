...
<input type="text" class="form-control" name="custom_panel_name" placeholder="Eg. Policy information" required/>
        ...
        <p>Please select the client</p>
          ...
          <input type="text" name="new_client" class="form-control pull-left marl" style="width:200px; display:none" placeholder="Enter the client name"/>
        </div>
                        <div class="form-group input-group-sm">
...
<option value="0">Not Live</option>
        ...
        <p>Please set the start date</p>
                    <div class="input-group">
                      <input  data-date-format="DD/MM/YYYY" name="start_date" type="text" class="form-control date" placeholder="Start Date">
        ...
        <p>Please set the end date</p>
                    <div class="input-group">
                      <input name="end_date" data-date-format="DD/MM/YYYY" type="text" class="form-control date" placeholder="End Date">
                      <span class="input-group-btn">
                      <button class="btn btn-default clear-input" type="button">Clear</button>
                      </span></div>
        </div>
