<ul class="nav nav-tabs" id="company-tabs" style=" background:#eee; width:100%;">
    ...
    <div class="tab-pane active" id="general">
        <form class="form-horizontal">
            ...
            <div class='form-group input-group-sm' data-picktime="false">
                ...
                <div class="col-sm-9">
                    <input name="date_of_creation" placeholder="Date of Creation" type='text'
                           class="form-control dateyears" value=""/>
                </div>
            </div>
        </form>
    </div>
        ...
        <form class="form-horizontal" id="company-address-form">
                ...
                <div class="col-md-9">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <!-- /btn-group -->
                            <input type="text" class="form-control input-sm" placeholder="Address description" name="description" value="">
                        </div>
                        <!-- /input-group -->
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <?php if (in_array("get address", $_SESSION['permissions'])) { ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <button class="btn btn-sm btn-info get-company-address" style="width:95%">Find Address
                            </button>
                        </div>
                    </div>
                    <div class="col-md-3">
...
<script>
     ...
     */
    $modal.find("#company-phone-form .description-list li a").click(function () {
        $('#company-phone-form').find('input[name="description"]').val($(this).text());
    });

    //Get address

    $modal.find("#company-address-form .description-list li a").click(function () {
        $('#company-address-form').find('input[name="description"]').val($(this).text());
    });

    var addresses;
    $modal.find('.address-select').hide();
    $modal.find('#company-address-form').find('input[name="house_number"]').numeric();
    ...
    function get_addresses() {
        ...
        var description = $('#company-address-form').find('input[name="description"]').val();
        ...
        $('#company-address-form').find('input[name="description"]').val(description);
