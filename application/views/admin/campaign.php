        ...
        <div class="col-lg-12">
           ...
           <div class="panel panel-primary campaign-panel">
            ...
            <div class="pull-right">
              <div class="btn-group">
<button type="button" class="btn btn-default btn-xs dropdown-toggle add-btn" data-toggle="dropdown"> Add Campaign</button></div></div>
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
            <?php $this->view('forms/edit_campaign_form.php',$options); ?>
             <table class="table ajax-table"><thead><tr><th>ID</th><th>Name</th><th>Type</th><th>Client</th><th>Status</th><th>Start Date</th><th>End Date</th><th>Options</th></tr></thead>
             <tbody>
<tr><td colspan="8"><img src="<?php echo base_url(); ?>assets/img/ajax-loader-bar.gif" /></td></tr>
             </tbody>
             </table>
            </div>
            <!-- /.panel-body --> 
...
<td><select disabled multiple style="height:200px" class="form-control outcome-select"><option value="">Select a campaign first</option></select></td>
<td width="110">
<div class="btn-group-vertical">
<button  type="button" disabled class="btn btn-default outcome-add">Add <span class="glyphicon glyphicon-chevron-right"></span></button><br>
<button  type="button" disabled class="btn btn-default outcome-del"><span class="glyphicon glyphicon-chevron-left"></span> Remove </button>
</div>
</td>
