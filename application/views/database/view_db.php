            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-primary groups-panel">
                        <div class="panel-heading"><i class="fa fa-bar-chart-o fa-fw"></i>Database
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <?php if (in_array("database", $_SESSION['permissions'])) { ?>
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        Drop all tables in the database. This will destroy the current databse <img
                                            style="display:none" class="pull-right"
                                            src="<?php echo base_url(); ?>assets/img/ajax-loader-bar.gif"/></li>
                                    <li class="list-group-item">
                                        <button class="btn create-tables btn-success" style="width:130px">Update Schema
                                        </button>
                                        Updates the database to the latest version<img class="pull-right"
                                                                                       style="display:none"
                                    ...
                                    <li class="list-group-item">
                                        <button class="btn reset-data btn-danger" style="width:130px">Reset default data
                                        </button>
                                        Reset the data to the default version. This will destroy the current data <img
                                            style="display:none" class="pull-right"
                                            src="<?php echo base_url(); ?>assets/img/ajax-loader-bar.gif"/></li>
                                    <li class="list-group-item">
                                        <button class="btn btn-success add-real-data" style="width:130px">Load real data
                                        </button>
                                        Adds real data (Users) <img class="pull-right" style="display:none"
                                                                    src="<?php echo base_url(); ?>assets/img/ajax-loader-bar.gif"/>
                                    </li>
                                    <li class="list-group-item">
                                        <button class="btn btn-warning add-data" style="width:130px">Load demo data</button>
                                        Adds some dummy client data <img class="pull-right" style="display:none"
                                                                         src="<?php echo base_url(); ?>assets/img/ajax-loader-bar.gif"/>
                                    </li>
                                </ul>
                            <?php } ?>
        ...
        $(document).ready(function () {
            ...
            function add_demo_data($btn, $reset) {
                if ($reset) {
                    ...
                    $.ajax({
                        url: helper.baseUrl + 'database/reset_data',
                        dataType: "JSON",
                        beforeSend: function () {
                            $btn.parent().find('img').show();
                        }
                    ...
                    $.ajax({
                        url: helper.baseUrl + 'database/add_data',
                        dataType: "JSON",
                        beforeSend: function () {
                            $btn.parent().find('img').show();
                        }
            ...
            function add_real_data($btn, $sample) {
                if ($sample) {
                    ...
                    $.ajax({
                        url: helper.baseUrl + 'database/add_real_data',
                        dataType: "JSON",
                        beforeSend: function () {
                            $btn.parent().find('img').show();
                        }
