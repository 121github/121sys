    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">Data Capture Report</h1>
      </div>
      <!-- /.col-lg-12 --> 
    </div>
    <!-- /.row -->
    <div class="row">
      <div class="col-lg-12">
        <div class="panel panel-primary">
          <div class="panel-heading clearfix"> <i class="fa fa-bar-chart-o fa-fw"></i> Data Capture Report
          ...
          <!-- /.panel-heading -->
          <div class="panel-body capture-panel"> <img src="<?php echo base_url(); ?>assets/img/ajax-loader-bar.gif" /> </div>
          <!-- /.panel-body --> 
        </div>
      </div>
