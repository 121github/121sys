<div class="row">
    <div class="col-lg-8">
        <h1 class="page-header">Last Outcomes Report</h1>
    </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-primary">
            ...
            <!-- /.panel-heading -->
            <div class="panel-body last-outcomes-panel  table-responsive" style="padding: 0px;">
                <div class="row">
                    <div class="col-lg-8">
                        <table class="table last-outcomes-table" style="padding: 10px;">
                            <thead></thead>
                            <tbody>
                            <tr>
                                <td>
