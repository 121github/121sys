<form class="form-restore_password" role="form" method="post">
    <h2 class="form-restore_password-heading">Restore the password</h2>
         <div class="form-group">
             ...
             <input type="password" name="new_pass" class="form-control" placeholder="New Password" <?php echo ($this->session->flashdata('username')?"autofocus":"") ?> required>
             <input type="password" name="conf_pass" class="form-control" placeholder="Confirm Password" <?php echo ($this->session->flashdata('username')?"autofocus":"") ?> required>
        </div>
