 <?php if(isset($collapsable)){ ?>    
     ...
     <div id="recordings-panel" class="panel panel-primary">
      <div class="panel-heading clearfix" role="button" data-toggle="collapse"  data-target="#recordings-panel-slide" aria-expanded="true" aria-controls="recordings-panel-slide">Recordings</div>
