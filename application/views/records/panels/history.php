<?php if(isset($collapsable)){ ?> 
      ...
      <div class="panel panel-primary" id="history-panel">
        <div class="panel-heading clearfix" role="button" data-toggle="collapse"  data-target="#history-panel-slide" aria-expanded="true" aria-controls="company-panel-slide">History</div>
