    <div class="panel panel-primary company-panel">
     ...
     <?php if(isset($details['company'])){ ?>
      <ul class="list-group company-list">
        ...
        <li  class="list-group-item" item-id="<?php echo $id ?>"><a data-toggle="collapse" data-parent="#accordion" href="#com-collapse-<?php echo $id ?>"> <?php echo $company["Company Name"]; ?></a> <span class="glyphicon glyphicon-trash pull-right del-company-btn" data-target="#modal" item-id="<?php echo $id ?>" ></span> <?php if(in_array("edit companies",$_SESSION['permissions'])){ ?><span class="glyphicon glyphicon-pencil pull-right edit-company-btn"  item-id="<?php echo $id ?>"></span><?php } ?>
      ...
      <?php } else { ?><ul class="list-group"><li class="list-group-item">This record has no company details</li></ul><?php } ?>
