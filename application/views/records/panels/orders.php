 <?php if(isset($collapsable)){ ?>  
     <div  id="orders-panel" class="panel panel-primary">
        <div class="panel-heading clearfix" role="button" data-toggle="collapse"  data-target="#orders-panel-slide" aria-expanded="true" aria-controls="orders-panel-slide">Orders <button class='btn btn-xs btn-default pull-right' id='create-order'><span class="glyphicon glyphicon-plus" id="new-sms-btn"></span> New</button></div>
