...
<div id="email-panel" class="panel panel-primary">
	<div class="panel-heading clearfix" role="button" data-toggle="collapse" data-parent="#detail-accordion" href="#emails-panel-slide" aria-expanded="true" aria-controls="emails-panel-slide">Emails <?php if(in_array("send email",$_SESSION['permissions'])){ ?><button class="btn btn-default btn-xs pull-right pointer" id="new-email-btn"><span class="glyphicon glyphicon-envelope"></span> New</button><?php } ?></div>
