 <?php if(isset($collapsable)){ ?>  
     <div id="tasks-panel" class="panel panel-primary">
        <div class="panel-heading clearfix" role="button" data-toggle="collapse"  data-target="#tasks-panel-slide" aria-expanded="true" aria-controls="tasks-panel-slide">Tasks <button class='btn btn-xs btn-default pull-right' id='task-history'>View History</button></div>
