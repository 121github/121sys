 <div class="panel panel-primary contact-panel">
      ...
      <ul class="list-group contacts-list">
        ...
        <li  class="list-group-item" item-id="<?php echo $id ?>"><a data-toggle="collapse" data-parent="#accordion" href="#con-collapse-<?php echo $id ?>"> <?php echo ($contact['name']["use_full"]?$contact['name']['fullname']:$contact['name']['title'] ." ".$contact['name']['firstname']." ".$contact['name']['lastname']); ?> </a> <?php if(in_array("edit contacts",$_SESSION['permissions'])){ ?><span class="glyphicon glyphicon-trash pull-right del-contact-btn" data-target="#modal" item-id="<?php echo $id ?>" ></span><?php } ?> <?php if(in_array("delete contacts",$_SESSION['permissions'])){ ?><span class="glyphicon glyphicon-pencil pull-right edit-contact-btn"  item-id="<?php echo $id ?>"></span><?php } ?>
