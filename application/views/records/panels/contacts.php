 <?php if(isset($collapsable)){ ?>
   ...
   <div class="panel-heading clearfix"  role="button" data-toggle="collapse" data-parent="#detail-accordion" href="#contact-panel-slide" aria-expanded="true" aria-controls="contact-panel-slide">
