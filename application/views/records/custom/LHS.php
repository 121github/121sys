...
<?php else: ?>
    <div class="page-header">
        ...
        <h2>
            View Details
            <small>
                URN: <?php echo $details['record']['urn'] ?> <?php if (!empty($details['record']['client_ref'])) { ?>
                    <span id="client-ref">Ref: <?php echo $details['record']['client_ref'] ?></span><?php } ?> <span
                    class='text-primary'><?php echo(!empty($details['record']['campaign']) ? " [" . $details['record']['campaign'] . "]" : "") ?><?php echo(!empty($details['record']['pot_name']) ? " [" . $details['record']['pot_name'] . "]" : "") ?></span>
            </small> <?php echo(!empty($details['record']['logo']) ? '<img style="max-height:40px" src="' . base_url() . 'assets/logos/' . $details['record']['logo'] . '" />' : ""); ?>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" id="record-options">
                        <?php if (in_array("planner", $_SESSION['permissions'])) { ?>
                            <li><a href="#" data-tab="tab-planner" data-modal="view-record"
                                   data-urn="<?php echo $details['record']['urn'] ?>">Add to planner</a></li>
