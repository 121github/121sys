...
<div class="row">
  <div class="col-md-6 col-sm-12"> 
    ...
    <div class="panel panel-primary contact-panel">
      <div class="panel-heading">
        <h4 class="panel-title"> Contact Details<span class="glyphicon glyphicon-plus pull-right add-contact-btn"></span> </h4>
      </div>
      <div class="form-container">
      ...
      <ul class="list-group contacts-list">
        ...
        <li  class="list-group-item" item-id="<?php echo $id ?>"><a data-toggle="collapse" data-parent="#accordion" href="#con-collapse-<?php echo $id ?>"> <?php echo ($contact['name']["use_full"]?$contact['name']['fullname']:$contact['name']['title'] ." ".$contact['name']['firstname']." ".$contact['name']['lastname']); ?> </a> <span class="glyphicon glyphicon-trash pull-right del-contact-btn" data-target="#modal" item-id="<?php echo $id ?>" ></span> <span class="glyphicon glyphicon-pencil pull-right edit-contact-btn"  item-id="<?php echo $id ?>"></span>
    ...
    <div class="panel panel-primary custom-panel">
      <div class="panel-heading">Additional Info <span class="glyphicon glyphicon-pencil pull-right edit-custom"></span></div>
 ...
 <?php if(in_array(3,$features)){ ?>
    <div class="panel panel-primary">
      ...
      <div class="panel-body history-panel"> <img src="<?php echo base_url(); ?>assets/img/ajax-loader-bar.gif" /> </div>
    </div>
    <?php } ?>
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body recordings-panel"> <img src="<?php echo base_url(); ?>assets/img/ajax-loader-bar.gif" /> </div>
    </div>
    <?php } ?>
    ...
    <div class="panel panel-primary record-panel">
      ...
      <div class="panel-body">
        ...
        <form>
          ...
          <div class="form-group">
            <textarea name="comments" class="form-control <?php if($details['record']['record_status']=="3"){ echo "red"; } ?>" rows="3" placeholder="Enter the call notes here"><?php if($details['record']['record_status']=="3"){ echo "This record has been removed with an outcome of ".$details['record']['outcome']. $deadtext; } ?>
</textarea>
          </div>
          <div class="form-group">
            <?php if($_SESSION['role']<3){ ?>
