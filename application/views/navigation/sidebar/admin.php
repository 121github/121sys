            ...
            <?php if (in_array("system menu", $_SESSION['permissions'])) { ?>
                ...
                <li><a href="#mm-system">System Config</a>
                    <ul id="mm-system">
                        ...
                        <li><a href="#mm-appearance">Appearance</a>
                            <ul id="mm-appearance">
                                <li <?php echo @($page == 'dash_settings' ? "class=Selected'" : "") ?>><a
                                        href="<?php echo base_url() ?>dashboard/settings">Dashboard Settings</a></li>
                                <li <?php echo @($page == 'panel_settings' ? "class=Selected'" : "") ?>><a
                                        href="<?php echo base_url() ?>panels/settings">Panel Settings</a></li>
                                <li <?php echo @($page == 'report_settings' ? "class=Selected'" : "") ?>><a
                                        href="<?php echo base_url() ?>reports/settings">Report Settings</a></li>
                            </ul>
                    </ul>
                </li>
            <?php } ?>
