                        ...
                        <form class="record-form" id="record-form">
                            ...
                            <div id="create-record">
                                ...
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                    <div class="panel" style="overflow:visible; padding: 10px;">
                                        <div class="" role="tab" id="headingOne">

                                            <div style="display:inline-block;width:30%">
                                                <label>Postcode</label>
                                                <input type="text" style="display:inline-block" name="postcode"
                                            ...
                                            <div style="display:inline-block;width:35%">
                                                ...
                                                <input style="display:inline-block" type="text"
                                                       class="form-control  input-sm" placeholder="House number"
                                                       id="house-number" name="" value="">
                                            </div>
                                            ...
                                            <div class="form-group" style="padding-top:10px">
                                                <div id="addresspicker-div" style="display:none">
                                                    <select class="form-control  input-sm addresspicker"
                                                            placeholder="Address" id="addresspicker">
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <a role="button" data-toggle="collapse" data-parent="#accordion"
                                               ...
                                               id="complete-company-address">Toggle full address view <i
                                                    class="fa fa-caret-down"></i>
                                            </a>
                                            <div id="collapse" class="panel-collapse collapse" style="padding-top:5px">
                                                <div class="form-group">
                                                    <input type="text" name="" id="add1" class="form-control input-sm"
                                                           placeholder="First line of address"/>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" name="" id="add2" class="form-control input-sm"
                                                           placeholder="Second line of address"/>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" name="" id="add3" class="form-control input-sm"
                                                           placeholder="Third line of address"/>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" name="" id="add4" class="form-control input-sm"
                                                ...
                                                <div class="form-group">
                                                    <input type="text" name="" id="city" class="form-control input-sm"
                                                           placeholder="Town/City"/>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" name="" id="county" class="form-control input-sm"
                                                           placeholder="County"/>
                                                </div>
                                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="" id="telephone" class="form-control  input-sm"
