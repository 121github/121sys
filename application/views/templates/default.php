...
<div class="navbar navbar-default navbar-fixed-top">
      ...
      <a href="#" class="navbar-brand pull-right"><img id="small-logo" style="margin-top:-10px;margin-right:5px;"
        ...
        src="<?php echo base_url(); ?>assets/themes/<?php echo(isset($_SESSION['theme_folder']) ? $_SESSION['theme_folder'] : "default"); ?>/logo.png"></a> </div>
<?php } ?>
</div>
...
<nav id="menu" class="mm-menu mm--horizontal mm-offcanvas">
      <?php if (isset($_SESSION['permissions'])) { ?>
      <ul>
    <li><a class="mm-title"> <small><span class="text-primary"><?php echo date('l jS F') ?></span> -
      Welcome <?php echo $_SESSION['name'] ?></small> </a></li>
...
<div class="container-fluid" id="container-fluid"> <?php echo $body; ?></div>
<!-- /content --> 
