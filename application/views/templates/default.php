...
<body>
<nav id="quick-actions-right" style="display:none; z-index: 110" class="mm-menu mm--horizontal mm-offcanvas">
    <div id="quick-actions" style="text-align: center">
        ...
        <?php if (in_array("list records", $_SESSION['permissions'])) { ?>
            <a type="button" class="btn btn-default" href="<?php echo base_url() ?>records/view" style="margin:0 3px 10px"><p>List
                    Records</p><span class="fa fa-table fa-3x"></span></a>
        <?php } ?>
        <?php if (in_array("view appointments", $_SESSION['permissions'])) { ?>
            <a type="button" class="btn btn-default" href="<?php echo base_url() ?>appointments" style="margin:0 3px 10px"><p>View
                    Appointments</p><span class="fa fa-clock-o fa-3x"></span></a>
        <?php } ?>
        <?php if (in_array("full calendar", $_SESSION['permissions'])) { ?>
            <a type="button" class="btn btn-default" href="<?php echo base_url() ?>booking" style="margin:0 3px 10px"><p>View
                    Calendar</p><span class="fa fa-calendar fa-3x"></span></a>
        <?php } ?>
        <?php if (in_array("view surveys", $_SESSION['permissions'])) { ?>
            <a type="button" class="btn btn-default" href="<?php echo base_url() ?>survey/view" style="margin:0 3px 10px"><p>View
                    Surveys</p><span class="fa fa-clipboard fa-3x"></span></a>
        <?php } ?>
        <?php if (in_array("search records", $_SESSION['permissions'])) { ?>
            <a type="button" class="btn btn-default" href="<?php echo base_url() ?>search" style="margin:0 3px 10px"><p>Search
