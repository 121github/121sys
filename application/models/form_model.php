...
class Form_model extends CI_Model
{
    ...
    {
        $qry = "select group_id id,group_name name,theme_images,theme_color from user_groups left join users using(group_id) left join users_to_campaigns using(user_id) where campaign_id in({$_SESSION['campaign_access']['list']}) group by user_groups.group_id";
        return $this->db->query($qry)->result_array();
    }
