...
class Branches_model extends CI_Model
{
	...
	public function get_branch_info($id=false,$postcode=false){
		...
		$driver_qry =  "select user_id id,name,user_email email,home_postcode,vehicle_reg from users join branch_region_users using(user_id) where attendee = 1 and region_id = ".$region_id;
