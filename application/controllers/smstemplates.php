...
'pageId' => 'Dashboard',
	...
	public function get_attachments_by_template_id() {
		...
		$attachmentList = $this->Sms_model->get_attachments_by_template_id($template_id);
		$auxList = array();
	...
	public function save_template()
	{
		...
		if ($form['template_id']) {
			$old_template = $this->Sms_model->get_template($form['template_id']);
	...
	public function save_attachment_by_template ($attachment_list, $template_id) {
		...
		foreach ($attachment_list as $attachment) {
			if (!($this->Sms_model->insert_attachment_by_template_id($template_id, $attachment))) {
				$response = false;
			}
		}
	...
	public function delete_attachment_by_id () {
		...
		if (!empty($data['id'])) {
			...
			$response = $this->Sms_model->delete_attachment_by_id($data['id']);
		}
...
//			}
	...
	public function delete_template(){
		...
		$attachment_list = $this->Sms_model->get_attachments_by_template_id($template_id);
