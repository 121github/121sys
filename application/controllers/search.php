...
class Search extends CI_Controller
{
	...
	public function quicksearch(){
		...
		public function filter_display(){
			...
			"record_status"=>array("name"=>"Record status","remove"=>$_SESSION['role_data_access']['dead']=="1"?true:false),
			"parked_code"=>array("name"=>"Parked code","remove"=>$_SESSION['role_data_access']['parked']=="1"?true:false),
			"group_id"=>array("name"=>"Group ownership","remove"=>$_SESSION['role_data_access']['group_records']=="1"?true:false),
			"user_id"=>array("name"=>"User ownership","remove"=>$_SESSION['role_data_access']['user_records']==1?true:false),
    ...
    public function custom()
    {
        ...
        $search_fields_2 = array(
            ...
            "user" => "users.name",
            "status" => "status_name",
            "contact-made" => "outcomes.contact_made",
            "nextcall" => "records.nextcall",
