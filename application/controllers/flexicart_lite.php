...
class Flexicart_lite extends CI_Controller {
		...
		function orders()
	{
		...
		$this->template->load('default', 'flexicart/feature_examples/order_form', $this->data);
	 ...
	 function show_session(){
		...
		$data = $this->orders_model->get_items($filter);
		echo json_encode(array("success"=>true,"data"=>$data));
