...
'pageId' => 'Reports',
    ...
    public function campaigndials()
    {
    	...
    	$data = array(
    			...
    			'page'=> array('reports'=>'campaign', 'inner' => 'campaigndials'),
    			'javascript' => array(
    					'charts.js',
    ...
    public function agenttransfer()
    {
    	...
    	$data = array(
    			...
    			'page'=> array('reports'=>'agent', 'inner' => 'agenttransfer'),
    			'javascript' => array(
    					'charts.js',
    ...
    public function agentdials()
    {
    	...
    	$data = array(
    			...
    			'page'=> array('reports'=>'agent', 'inner' => 'agentdials'),
    			'javascript' => array(
    					'charts.js',
    ...
    public function agentdials_data()
    {
    	if ($this->input->is_ajax_request()) {
    		$data= array();
    		$results = $this->Report_model->get_agentdials_report($this->input->post(), array("Transfer", "Cross Transfer"));
...
'pageId' => 'Reports',
    			...
    			'page'=> array('reports'=>'daily', 'inner' => 'dailytransfer'),
    			'javascript' => array(
    					'charts.js',
...
=======
    			'pageId' => 'Reports',
    			'title' => 'Reports | Individual Daily Comparison',
    			'page'=> array('reports'=>'daily', 'inner' => 'dailyappointment'),
>>>>>>> 076599a2b29e8dcad3e9d29bac9306758f4867ba
    			'javascript' => array(
    					'charts.js',
...
=======
    			'pageId' => 'Reports',
    			'title' => 'Reports | Individual Daily Comparison',
    			'page'=> array('reports'=>'daily', 'inner' => 'dailysurvey'),
>>>>>>> 076599a2b29e8dcad3e9d29bac9306758f4867ba
    			'javascript' => array(
    					'charts.js',
