...
class Flexicart_admin extends CI_Controller {
	...
	function __construct() 
	{
		...
		$this->load->vars('includes_dir', base_url().'assets/flexicart/');
	 ...
	 * Many of the functions within this controller load a custom model called 'orders_admin_model' that has been created for the purposes of this demo.
...
$this->template->load('default', 'flexicart/admin_examples/dashboard_view', $this->data); 
	...
	public function category_details(){
		...
		$category = $this->orders_admin_model->get_category($id);
		$category['subcategories'] = $this->orders_admin_model->subcategories_in_category($id);	
...
$this->template->load('default', 'flexicart/admin_examples/config/categories', $this->data);
	...
	$id = $this->orders_admin_model->save_category($form);	
	if($this->input->post('subcategories')){
	$subcategories = $form['subcategories'];
	unset($form['subcategories']);
	if($subcategories){
		foreach($subcategories as $subcat_id){
	$this->orders_admin_model->save_subcategory($subcat_id,$form['item_category_id']);	
		}
	}
	}
	...
	$categories = $this->orders_admin_model->get_item_categories();
	echo json_encode(array("success"=>true,"data"=>$categories));
	}
	
		public function get_subcategories(){
	$data = $this->orders_admin_model->get_item_subcategories($this->input->post('id'));
	...
	function items()
	{
		...
		{
			$this->orders_admin_model->demo_update_item_stock();
		}

		// Get an array of all demo items from a custom demo model function.
		$this->data['item_data'] = $this->orders_admin_model->demo_get_item_data();
...
$this->template->load('default', 'flexicart/admin_examples/orders/orders_view', $this->data);
	...
	function order_details($order_number) 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_update_order_details($order_number);
		}
...
$this->template->load('default', 'flexicart/admin_examples/orders/order_details_view', $this->data);
	...
	function update_order_details($order_number)
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_resave_order($order_number);
		}
		...
		$this->load->library('flexicart/flexi_cart');
...
$this->template->load('default','flexicart/admin_examples/orders/order_details_update_view', $this->data);
	...
	function location_types() 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_update_location_types();
		}
...
$this->template->load('default','flexicart/admin_examples/locations/location_type_update_view', $this->data);
	...
	function insert_location_type() 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_insert_location_type();
		}
...
$this->template->load('default','flexicart/admin_examples/locations/location_type_insert_view', $this->data);
	...
	function locations($location_type_id) 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_update_locations();
		}
...
$this->template->load('default','flexicart/admin_examples/locations/location_update_view', $this->data);
	...
	function insert_location($location_type_id) 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_insert_location($location_type_id);
		}
...
$this->template->load('default','flexicart/admin_examples/locations/location_insert_view', $this->data);
	...
	function zones() 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_update_zones();
		}
...
$this->template->load('default','flexicart/admin_examples/locations/zone_insert_view', $this->data);
	...
	function shipping() 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_update_shipping();
		}
...
$this->template->load('default','flexicart/admin_examples/shipping/shipping_update_view', $this->data);
	...
	function insert_shipping() 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_insert_shipping();
		}
...
$this->template->load('default','flexicart/admin_examples/shipping/shipping_insert_view', $this->data);
	...
	function shipping_rates($shipping_id) 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_update_shipping_rate();
		}
...
$this->template->load('default','flexicart/admin_examples/shipping/shipping_rate_update_view', $this->data);
	...
	function insert_shipping_rate($shipping_id) 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_insert_shipping_rate($shipping_id);
		}
...
$this->template->load('default','flexicart/admin_examples/shipping/shipping_rate_insert_view', $this->data);
	...
	function item_shipping($item_id) 
	{
		...
		{		
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_update_item_shipping();
		}
...
$this->template->load('default','flexicart/admin_examples/items/item_shipping_update_view', $this->data);
	...
	function insert_item_shipping($item_id) 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_insert_item_shipping($item_id);
		}
...
$this->template->load('default','flexicart/admin_examples/items/item_shipping_insert_view', $this->data);
	...
	function tax() 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_update_tax();
		}
...
$this->template->load('default','flexicart/admin_examples/tax/tax_update_view', $this->data);
	...
	function insert_tax() 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_insert_tax();
		}
...
$this->template->load('default','flexicart/admin_examples/tax/tax_insert_view', $this->data);
	...
	function item_tax($item_id) 
	{
		...
		{		
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_update_item_tax();
		}
...
$this->template->load('default','flexicart/admin_examples/items/item_tax_update_view', $this->data);
	...
	function insert_item_tax($item_id) 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_insert_item_tax($item_id);
		}
...
$this->template->load('default','flexicart/admin_examples/items/item_tax_insert_view', $this->data);
	...
	function item_discounts() 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_update_discounts();
		}
...
$this->template->load('default','flexicart/admin_examples/discounts/discounts_view', $this->data);
	...
	function update_discount($discount_id) 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_update_discount($discount_id);
		}
...
$this->template->load('default','flexicart/admin_examples/discounts/discount_update_view', $this->data);
	...
	function insert_discount() 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_insert_discount();
		}
...
$this->template->load('default','flexicart/admin_examples/discounts/discount_insert_view', $this->data);
	...
	function discount_groups() 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_update_discount_groups();
		}
...
$this->template->load('default','flexicart/admin_examples/discounts/discount_groups_view', $this->data);
	...
	function update_discount_group($group_id) 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_update_discount_group($group_id);
		}
...
$this->template->load('default','flexicart/admin_examples/discounts/discount_group_insert_view', $this->data);
	...
	function insert_discount_group_items($group_id) 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_insert_discount_group_items($group_id);
		}
...
$this->template->load('default','flexicart/admin_examples/reward_points/user_reward_point_history_view', $this->data);
	...
	function user_vouchers($user_id) 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_update_voucher();
		}
...
$this->template->load('default','flexicart/admin_examples/reward_points/vouchers_view', $this->data);
	...
	function convert_reward_points($user_id) 
	{
		...
		{
			$this->orders_admin_model->demo_convert_reward_points($user_id);
		}
		...
		$user_data = $this->orders_admin_model->demo_reward_point_summary($user_id);
...
$this->template->load('default','flexicart/admin_examples/reward_points/user_reward_point_convert_view', $this->data);
	...
	function currency() 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_update_currency();
		}
...
$this->template->load('default','flexicart/admin_examples/currency/currency_insert_view', $this->data);
	...
	function order_status() 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_update_order_status();
		}
...
$this->template->load('default','flexicart/admin_examples/orders/order_status_insert_view', $this->data);
	...
	function config() 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_update_config();
		}
...
$this->template->load('default','flexicart/admin_examples/config/config_update_view', $this->data);
	...
	function defaults() 
	{
		...
		{
			$this->load->model('orders_admin_model');
			$this->orders_admin_model->demo_update_defaults();
		}
