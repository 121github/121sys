...
var template = {
    ...
    edit: function ($btn) {
        ...
        $.ajax({
            ...
            if (result.data.history_visible == "1") {
                $('#container-fluid form').find('#history-visible-yes').prop('checked', true).parent().addClass('active');
                $('#container-fluid form').find('#history-visible-no').prop('checked', false).parent().removeClass('active');
            } else {
                $('#container-fluid form').find('#history-visible-no').prop('checked', true).parent().addClass('active');
                $('#container-fluid form').find('#history-visible-yes').prop('checked', false).parent().removeClass('active');
            }
