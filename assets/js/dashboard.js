    ...
    progress_panel: function (agent, campaign) {
        $.ajax({
            ...
            if (response.data.length > 0) {
                ...
                $('.progress-panel').append('<table class="table table-striped table-responsive" style="height:800px"><thead><th>Name</th><th>Campaign</th><th>Date</th><th>Time</th><th>Status</th><th>View</th></thead><tbody>' + $row + '</tbody></table>');
				$('.tt').tooltip();
            } else {
