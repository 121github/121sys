var orders = {
		...
		$(document).on('click','.add-item-btn',function(e)
	{
		...
		$.ajax(
		{
			url: helper.baseUrl+'shop/insert_ajax_form_item_to_cart',
			type: 'POST',
			data: form_data,
	...
	$.ajax(
		{
			url: helper.baseUrl+'shop/view_cart',
			type: 'POST',
			success:function(data)
			{
	...
	$.ajax(
		{
			url: helper.baseUrl+'shop/checkout',
			type: 'POST',
			data: { checkout:true },
			dataType:"JSON",
	...
	get_subcategories:function(id){
		 $.ajax({
                url: helper.baseUrl + 'admin_shop/get_subcategories',
                type: "POST",
                dataType: "JSON",
                data: {
                    'id': id
	...
	get_items:function(){
		 $.ajax({
                url: helper.baseUrl + 'lite_shop/get_items',
                type: "POST",
                dataType: "JSON",
                data: {
	...
	refresh_quantities:function(){
		 $.ajax({
                url: helper.baseUrl + 'lite_shop/get_cart_quantities',
                type: "POST",
				dataType:"JSON",
                fail: function () {
	...
	checkout:function(action){
		...
		remove_discount:function(id){
		 $.ajax({
                url: helper.baseUrl + 'shop/unset_discount',
                type: "POST",
                data: {id:id},
                fail: function () {
